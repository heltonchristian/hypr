...
# Instalar programas
sudo pacman -S --noconfirm git go hyprland qt5-wayland qt6-wayland wayland-utils desktop-portal-hyprland dkms nvidia-dkms intel-ucode dunst grim slurp waybar zsh kitty vim wmofi nemo htop papirus-icon-theme ttf-nerd-fonts-symbols ttf-fira-code ttf-font-awesome neofetch ncspot pavucontrol firefox chromium libreoffice-fresh orchis-theme nwg-look
